...
extension NewsfeedCollectionViewController: PinterestLayoutDelegate {
    ...
    func height(for text: String, with font: UIFont, width: CGFloat) -> CGFloat {
        ...
        let textAttributes = [kCTFontAttributeName: font]
        
        let boundingRect = nsstring.boundingRect(with: CGSize(width: width, height: maxHeight), options: .usesLineFragmentOrigin, attributes: textAttributes as [NSAttributedString.Key : Any], context: nil)
